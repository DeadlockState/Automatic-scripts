...
if [ "$USER" = "root" ] ; then
	...
	apt-get install -y php7.0-fpm php7.0-* > /dev/null
	...
	wget https://raw.githubusercontent.com/Punk--Rock/Configuration-files/master/nginx/nginx.conf > /dev/null
	...
	if [ "$INSTALL_PHPMYADMIN" = "y" ] ; then
		...
		wget https://raw.githubusercontent.com/Punk--Rock/Configuration-files/master/nginx/sites-available/default.conf > /dev/null
	...
	wget https://raw.githubusercontent.com/Punk--Rock/Configuration-files/master/php/7.0/fpm/pool.d/www.conf > /dev/null
